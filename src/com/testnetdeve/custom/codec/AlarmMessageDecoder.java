 ...
 *
 */
public class AlarmMessageDecoder extends LengthFieldBasedFrameDecoder {
	 ...
	 * @throws IOException 
	 */
	public AlarmMessageDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength) throws IOException {
