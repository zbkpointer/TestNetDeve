...
public class TestCodeC {
	...
	public AlarmMessage getMessage() {
		...
		alarmMessage.setBody("abcdefg-----------------------64位MAC地址");
		return alarmMessage;
	}

	public ByteBuf encode(AlarmMessage msg) throws Exception {
	...
	public AlarmMessage decode(ByteBuf in) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		AlarmMessage message = testC.getMessage();
		System.out.println(message + "[body ] " + message.getBody());

		for (int i = 0; i < 5; i++) {
			ByteBuf buf = testC.encode(message);
			AlarmMessage decodeMsg = testC.decode(buf);
